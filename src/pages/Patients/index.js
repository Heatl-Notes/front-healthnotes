            ...
            <div className="patient__cards">
                ...
                <div className="patient_card">
                    ...
                    <div className="card_inner">
                        ...
                        <p><span class="font-bold">Nome:</span> José Silva</p>
                        <p><span class="font-bold">Idade:</span> 77</p>
                        <p><span class="font-bold">Doenças crônicas:</span> (POSSUI)</p>
                        <p><span class="font-bold">Procedimentos especializados:</span> (PRECISA)</p>
                ...
                <div className="patient_card">
                    ...
                    <div className="card_inner">
                        ...
                        <p>
                            <span class="font-bold">Nome:</span> José Silva
                        </p>
                        <p>
                            <span class="font-bold">Idade:</span> 77
                        </p>
                        <p>
                            <span class="font-bold">Doenças crônicas:</span> (POSSUI)
                        </p>
                        <p>
                            <span class="font-bold">Procedimentos especializados:</span> (PRECISA)
                        </p>
                    </div>
                </div>
